module.exports = {
    ...
    remoteServerPath: 'admin@192.168.10.20:/home/admin/Desktop/project/view-img', // 远程服务器的地址和目录
    localDist: 'dist',  // 上传之前暂存文件的目录, 每次上传成功后会自动删除, 上传失败则会保留
    versionFile: 'public/v.txt', // 打包时会将打包时间和git提交id写入这个文件中, 这个文件会上传到remoteServerPath的路径后面, 如果不需要生成版本文件可以注释此项
